              ...
              {displayedCourses.map((course) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3
                      onClick={() => navigate(`/course/${course.course_id}`)}
                      className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 cursor-pointer group-hover:text-blue-600 transition-colors duration-200"
                    >
                    ...
                    <div className="flex flex-col gap-3">
                      <button
                        onClick={() => navigate(`/course/${course.course_id}`)}
                        className="w-full py-3 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 text-gray-700 font-semibold hover:from-gray-100 hover:to-gray-200 transition-all duration-200 border border-gray-200 shadow-sm hover:shadow-md"
                      >
                        View Details
                      </button>
